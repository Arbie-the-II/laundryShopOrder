    ...
    <style>
        ...
        @media print {
            body {
                ...
                font-size: 10pt; /* Smaller font for better density */
                color: #000;
            }
            .container {
                width: 100%;
            ...
            .kpi-box, .chart-box {
                ...
                page-break-inside: avoid; /* Prevent breaking boxes across pages */
            }
            .kpi-row, .chart-row {
                /* Ensure sections are printed full width */
                display: block; 
                gap: 0;
            }
            .kpi-box {
            ...
            .chart-box {
                ...
                min-width: 100%;
                width: 100%;
                /* Chart.js needs a moment to render for print. Setting a height helps. */
                height: auto; 
            }
            /* Make tables solid black for printing */
            .data-table th, .data-table td {
                border-color: #000;
            }
            .data-table th {
...
<body>
    <div class="container">
        ...
        <p class="no-print"><a href="../dashboard.php">← Back to Dashboard</a></p>
